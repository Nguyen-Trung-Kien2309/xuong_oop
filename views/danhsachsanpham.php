        ...
        <tbody>
            <?php foreach($listProduct as $key=>$product): ?>
                <tr>
                    ...
                    <td>
                        <a href="./?act=form-sua-san-pham&id=<?php echo $product['id']; ?>">
                            <button>Sửa</button>
                        </a>
                        <a href="./?act=xoa-san-pham&id=<?php echo $product['id']; ?>">
                            <button onclick="confirm('bạn có muốn xoa không')">Xóa</button>
                        </a>
                    </td>
                </tr>
            <?php endforeach ?>
